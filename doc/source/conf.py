# -*- coding: utf-8 -*-
#
# dnutils documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../%s' % _version.__basedir__))

import sphinx_bootstrap_theme


def setup(app):
    app.add_stylesheet('default.css')  # may also be an URL
